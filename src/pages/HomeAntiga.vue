<template>
  <b-container fluid>
    ...
    <b-row>
      <b-col>
        <modal width="90%" name="adicionar-gastos" :scrollable="true" resizable clickToClose height="90%" >
          <b-container>
            ...
            <b-row v-show="antesBusca">
              <b-col>
                ...
                <b-row class="text-center">
                  <b-col>
                    <span>Posicione o QR Code corretamente!</span>
                  </b-col>
                </b-row>
              </b-col>
            </b-row>
            ...
            <b-row v-show="depoisBusca">
              <b-col>
                ...
                <b-row>
                  <b-col>
                    <b-table striped hover :items="itens" :fields="campos" sticky-header small bordered>
